    ...
    if(mapElement) {
        ...
        const fetchApiData = async () => {
            ...
            try{
                                        ...
                                        <div class="leaflet-title">                            
                                            ...
                                            <table class="table-auto w-full">
                                                <tr class="text-xl">
                                                    ...
                                                    <td class="px-2 py-2 whitespace-nowrap"><h4 class="text-xl">${parseFloat(_pm2ug).toFixed(2)}</h4></td>
                ...
                //             const cheElementsInd = (elementValue, arrayElements) =>{
                //                 if(elementValue < 1) {
                //                     nValue =`
                //                     <img src="./assets/img/Semponto.png" class="leaflet-nvalue" alt="sem ponto" />`;
                //                     colorForPm2 = { color:'Gray', fillColor: '#e4e4e4',fillOpacity: _fillOpacity, radius: _radius };
                ...
                //             cheElementsInd(_pm2ug, _arrayIndicesPm2u);
