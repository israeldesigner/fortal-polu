    ...
    const fetchApiData = async () => {
      ...
      try {
        ...
        const newPoints = () => {
          ...
          const { tablesThomaz } = responseData
          console.log(tablesThomaz)
          for (const { Latitude, Longitude } of tablesThomaz) {
            console.log(Latitude)
            console.log(Longitude)
          }

          tablesThomaz.forEach((element, index) => {
            console.log(element)
            console.log(index)
          })
          ...
          //   L.marker(arrayLatLong, markerPoint).addTo(map).bindPopup('testando').openPopup();
        }
